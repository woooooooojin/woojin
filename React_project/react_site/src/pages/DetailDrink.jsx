...
export default function DetailDrink(props3) {
    ...
    <div>
        <div className="detail_wrap">
            ...
            <div className="detail_left">
                <h2 className='detail_tit'>{drinks[id].title}</h2>
                <p className='detail_desc'>{drinks[id].desc}</p>

            </div>


            <div className="detail_right">
                <img src={drinks[id].image} alt='img'/>
            </div>
