...
export default function DetailDessert(props) {
    ...
    <div>
        ...
        <div className="detail_wrap">
          ...
          <div className="detail_left">
            <h2 className='detail_tit'>{desserts[id].title}</h2>
            <p className='detail_desc'>{desserts[id].desc}</p>

          </div>


          <div className="detail_right">
            <img src={desserts[id].image} alt='img'/>
          </div>
