...
export default function DetailCoffee(props4) {
    const {coffees} = props4
    const {id} = useParams()
    ...
    <div>
        ...
        <div className="detail_wrap">
          ...
          <div className="detail_left">
            <h2 className='detail_tit'>{coffees[id].title}</h2>
            <p className='detail_desc'>{coffees[id].desc}</p>

          </div>


          <div className="detail_right">
            <img src={coffees[id].image} alt='img'/>
          </div>
